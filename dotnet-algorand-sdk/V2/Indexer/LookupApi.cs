...
namespace Algorand.V2.Indexer
{
    ...
    public partial interface ILookupApi
    {
        ...
        /// <returns>(empty)</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Response9> AssetsAsync(BigInteger asset_id, bool? include_all);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <param name="include_all">Include all items including closed accounts, deleted applications, destroyed assets, opted-out asset holdings, and closed-out application localstates.</param>
        /// <returns>(empty)</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Response9> AssetsAsync(BigInteger asset_id, bool? include_all, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class LookupApi : ILookupApi
    {
        ...
        /// <returns>(empty)</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Response9> AssetsAsync(BigInteger asset_id, bool? include_all)
        {
        ...
        /// <returns>(empty)</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Response9> AssetsAsync(BigInteger asset_id, bool? include_all, System.Threading.CancellationToken cancellationToken)
        {
            if (asset_id == null)
